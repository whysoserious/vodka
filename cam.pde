...
void keyReleased() {
  ...
  switch(key) {
    case ' ': stopRec(); break;
    case '0': setCamera(0); break;
    case '1': setCamera(1); break;
    case '2': setCamera(2); break;
    case '3': setCamera(3); break;
    case '4': setCamera(4); break;
    case '5': setCamera(5); break;
    case '6': setCamera(6); break;
    case '7': setCamera(7); break;
    case '8': setCamera(8); break;
    case '9': setCamera(9); break;    
  }
}
